...
10. Incluir o tipo de item com o argumento `itemtype`. Para itens dicotômicos (IME), adotar `3PL`. Para itens politômicos (IRC), adota `graded`.
...
4. A exclusão deve ser feita atribuindo `a1=0` e `est=FALSE` na tabela de parâmetros para os itens excluídos
